  ...
  return (
    <div>
      <div className="filter-box flex justify-between items-center my-7 relative">
          ...
          <div className="lg:block hidden">
            <form className="flex justify-end items-center max-w-full">
              ...
              <div className="flex items-center justify-center mr-7">
                ...
                <span
                  className={`w-10 h-3 rounded-full ml-4 bg-[#D0D0D0] flex items-center ${
                    mySwitchDetails ? "justify-start" : "justify-end"
                  }`}
                >
                  <span
                    onClick={handleSwitchDetails}
                    className={`w-[20px] h-[20px] rounded-full inline-block  cursor-pointer ${
                      mySwitchDetails ? "bg-gray-400" : " bg-[#8F8F8F]"
                    } `}
                  ></span>
                </span>
              </div>
              ...
              <div className="flex items-center justify-center mr-7">
                ...
                <span
                  className={`w-10 h-3 rounded-full ml-4 bg-[#DBC7F5] flex items-center ${
                    mySwitchSalary ? "justify-start" : "justify-end"
                  }`}
                >
                  <span
                    onClick={handleSwitchSalary}
                    className={`w-[20px] h-[20px] rounded-full inline-block  cursor-pointer ${
                      mySwitchSalary ? "bg-gray-400" : " bg-[#5B48D2]"
                    }`}
                  ></span>
                </span>
              </div>
        ...
        {/* onCanvas menu */}
        <div
          className={`lg:hidden block onCanvas-menu ${
            jobFilterToggle ? "add-toggle" : "remove-toggle"
          }`}
        >
          <form className="flex justify-end items-start flex-col max-w-full mr-7 ">
            ...
            <div className="flex items-center justify-center mt-4">
              <span
                className={`w-10 h-3 rounded-full bg-[#D0D0D0] flex items-center ${
                  mySwitchDetails ? "justify-start" : "justify-end"
                }`}
              >
                <span
            ...
            <div className="flex items-center justify-center mt-4">
              <span
                className={`w-10 h-3 rounded-full bg-[#DBC7F5] flex items-center ${
                  mySwitchSalary ? "justify-start" : "justify-end"
                }`}
              >
                <span
